    ...
    const handleMouseEnter = (e: MouseEvent) => {
        ...
        if (align) {
            if (appearance === 'horizontal') {
                ...
                if (vertical === 'middle') {
                    topPos =
                        top + (height - tooltipRef.current.clientHeight) / 2;
                    arrowPos.y = 'middle';
                }
                if (vertical === 'bottom') {
                ...
                if (horizontal === 'right') {
                    leftPos =
                        left + width - tooltipRef.current.clientWidth + 10;
                    arrowPos.x = 'right';
                }
                if (horizontal === 'middle') {
                    leftPos =
                        left + (width - tooltipRef.current.clientWidth) / 2;
                    arrowPos.x = 'middle';
                }
            }
        } else {
            if (left <= tooltipRef.current.clientWidth / 2) {
                ...
                arrowPos.x = 'right';
                leftPos =
                    left + width / 2 - tooltipRef.current.clientWidth + 10;
            } else {
                arrowPos.x = 'middle';
